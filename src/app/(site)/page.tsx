...
import { fokusPageHeroImages, getBlogListCoverByIndex, serviceCardImages } from "@/data/site-images";
        ...
        <div className="mx-auto max-w-[1068px] px-6">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {posts.map((p, idx) => {
              ...
              const cover = getBlogListCoverByIndex(coverIdx >= 0 ? coverIdx : idx);
              return (
                <Link
                  key={p.slug}
                  href={`/blog/${p.slug}`}
                ...
                >
                  <div className="relative aspect-[16/9] w-full bg-[#f5f5f7]">
                    <Image src={cover} alt="" fill className="object-cover transition duration-700 group-hover:scale-[1.03]" sizes="45vw" />
                  </div>
