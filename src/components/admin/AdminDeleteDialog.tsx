...
export function AdminDeleteDialog({ open, title, entityLabel, onCancel, onConfirm, working }: Props) {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" role="dialog" aria-modal="true">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-black/[0.08] bg-white p-6 shadow-[var(--apple-shadow-lg)]">
        <h2 className="font-serif text-lg font-medium text-[var(--apple-text)]">{entityLabel} löschen?</h2>
